    ...
    <div id="container">
        ...
        <div id="refinePanel">
          <div id="refineByCategory">
            ...
            <a href="resultsPage2.jsp?value=halls">Halls</a><br>
            <a href="resultsPage2.jsp?value=Pandit">Pandit</a><br>
            <a href="resultsPage2.jsp?value=Jewellery">Jewellery</a><br>
            <a href="resultsPage2.jsp?value=Travel">Travel</a><br>
            <a href="resultsPage2.jsp?value=Photography">Photography</a><br>
            <a href="resultsPage2.jsp?value=food">Food</a><br>
...
out.println("<p>info:"+rs.getString(5)+"</p>");
out.println("<p>Location:"+rs.getString(3)+"</p>");
out.println("<p>phone:"+rs.getString(4)+"</p>");
